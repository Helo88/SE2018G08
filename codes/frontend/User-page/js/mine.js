...
$(".dddd").click(function(){
    $(".dddd").hide(200);
    $(".table-travles").css("display","block");
    
});
$(".My-travel").click(function(){
    $(".table-travles").css("display","none");
    $(".dddd").show();
})
